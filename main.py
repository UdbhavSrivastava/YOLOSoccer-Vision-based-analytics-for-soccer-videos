...
def main():
    # Read Video
    video_frames = read_video('input_videos/abcd.mp4')
    ...
    #compress_video('output_videos/output_video7.mp4', 'output_videos/output_video7_compressed.mp4')

    # Compress input.mp4 to 50MB and save as output.mp4
    #compress_video('output_videos/output_video7.mp4', 'output_videos/output_video7_Com.mp4', 20 * 1000)
